...
public class Block6 implements BlockInterface {
	
	private Image block = new ImageIcon(Main.class.getResource("../images/blocks/6.png")).getImage();
	...
	public void fixLocation() {
		...
		for(int i = 0; i < points.size(); i++) {
			...
			Board.position[points.get(i).getX()][points.get(i).getY()][1] = Board.COLOR_RED; // 각각 다름
		}
		try {
			Thread.sleep(200);
		...
		Board.newBlocks.remove(Block6.this);// 각각 다름.
